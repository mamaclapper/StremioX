...
6. **Themes.** Built-in themes and a theme studio for your own colours, a true-black OLED mode, a layout you can rearrange, themes you can share, backgrounds that take their colour from the artwork, and a player with motion that has character.
